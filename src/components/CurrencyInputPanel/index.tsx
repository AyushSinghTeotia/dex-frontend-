import { Currency, Pair, ChainId } from 'quest-cyswap-sdk'
...
export default function CurrencyInputPanel({
    ...
    return (
        <div id={id} className="rounded bg-dark-800 pt-5 pb-1 pl-3 pr-3">
             <div
                            ...
                            {pair ? (
                                ...
                                <div className="flex flex-1 flex-col items-start justify-center w-full text-left mx-3.5 overflow-x-hidden">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        > */}
                                        <div className="text-lg md:text-2xl font-bold whitespace-nowrap text-clr">
