        ...
        <div className="swap-header-outer flex justify-between space-x-2 bg-dark-600">
            <div className="grid grid-cols-2 p-3px bg-dark-600">
                <NavLink
                    ...
                    activeClassName="font-bold text-high-emphesis bg-dark-825"
                    to={{
                        pathname: '/swap',
               ...
               [ChainId.RINKEBY, ChainId.BSC, ChainId.BSC_TESTNET].includes(chainId) && (
                <NavLink
                    className="flex-col flex items-center pb-4 pt-3 justify-center px-4 md:px-10 text-center text-secondary hover:text-high-emphesis text-base font-medium"
                    activeClassName="text-high-emphesis font-bold bg-dark-825"
            ...
            <div className="flex items-center md:border-dark-600 md:p-4 box-height-x">
