...
export const CYYSWAP_SWAPPER_ADDRESS: {
    [chainId in ChainId]: string
} = {
...
export const CYYSWAP_MULTISWAPPER_ADDRESS: {
    [chainId in ChainId]: string
} = {
...
export const CYYSWAP_MULTI_EXACT_SWAPPER_ADDRESS = {
...
export const CYYSWAP_TWAP_0_ORACLE_ADDRESS = '0x66F03B0d30838A3fee971928627ea6F59B236065'

export const CYYSWAP_TWAP_1_ORACLE_ADDRESS = '0x0D51b575591F8f74a2763Ade75D3CDCf6789266f'
...
export const USD_CURRENCY: { [chainId in ChainId]?: Currency } = {
    ...
    [ChainId.RINKEBY]: { address: '0xD9BA894E0097f8cC2BBc9D24D308b98e36dc6D02', decimals: 18 },
