...
import { Token, WETH } from 'quest-cyswap-sdk'
...
import usePendingCyy from '../../hooks/masterchefv2/usePendingCyy'
...
export default function InputGroup({
    ...
    const pending = usePendingCyy(pid)
    ...
    const [approvalState, approve] = useApproveCallback(
        ...
        '0xf5158bD8D5C4A66c3c1B40514A91373aEEE06e2b' //masterchefv2 on RInkeby
    )
            ...
            <div className="flex flex-col py-6 space-y-4">
                {pending && Number(pending) > 0 && (
                    <div className="px-4 ">
                        ...
                        >
                            Harvest {formattedNum(pending)} CYY & {formattedNum(reward)} ALCX
                        </Button>
                    </div>
                )}
                <div className="px-4">
