...
import { MASTERCHEF_ADDRESS, Token } from 'quest-cyswap-sdk'
...
import usePendingCyy from '../../hooks/masterchefv1/usePendingCyy'
...
export default function InputGroup({
    ...
    const [approvalState, approve] = useApproveCallback(
        ...
        "0x6A8F712294e9Eb20BE7C6Aa9208B769176Eefbf4"
    )
            ...
            <div className="flex flex-col space-y-4 py-6">
                ...
                {pending && Number(pending) > 0 && (
                    <div className=" px-4">
                        ...
                        >
                            {i18n._(t`Harvest ${formattedNum(pending)} CYY`)}
                        </Button>
                    </div>
                )}
            </div>
