...
import usePendingCyy from '../../hooks/minichef/usePendingCyy'
...
export default function InputGroup({
    ...
    const [approvalState, approve] = useApproveCallback(
        ...
        '0x6A8F712294e9Eb20BE7C6Aa9208B769176Eefbf4' //miniChef on Rinkeby
    )
            ...
            <div className="flex flex-col space-y-4 py-6">
                {pending && Number(pending) > 0 && (
                    <div className=" px-4">
                        ...
                        >
                            <Trans>
                                Harvest {formattedNum(pending)} CYY & {formattedNum(reward)} ETH
                            </Trans>
                        </Button>
                    </div>
                )}
