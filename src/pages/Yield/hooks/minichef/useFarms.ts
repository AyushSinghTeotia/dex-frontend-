    ...
    const fetchAllFarms = useCallback(async () => {
        const results = await Promise.all([
            ...
            exchange_matic.query({
                ...
                variables: { user: String('0x6A8F712294e9Eb20BE7C6Aa9208B769176Eefbf4').toLowerCase() } //minichef
            }),
        ...
        const farms = pools
            ...
            .map((pool: any) => {
                ...
                const rewardPerSecond = ((pool.allocPoint / totalAllocPoint) * pool.miniChef.tokenPerSecond) / 1e18
                const rewardPerDay = rewardPerSecond * 86400

                //console.log('pool:', pool.allocPoint, totalAllocPoint, pool.miniChef.tokenPerSecond)
                ...
                // const roiPerSecond = (rewardPerSecond * 2 * cyyPrice) / balanceUSD // *2 with matic rewards
                // console.log('rewardPerSecond:', rewardPerSecond)
                // console.log('secondaryRewardPerSecond:', secondaryRewardPerSecond)
                const roiPerSecond = (rewardPerSecond * cyyPrice + secondaryRewardPerSecond * maticPrice) / balanceUSD // *2 with matic rewards
                ...
                return {
                    ...
                    liquidityPair: pair,
                    rewardTokens: [
                        '0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a', //CYY on Matic
                        '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270' // MATIC on Matic
                    ],
                    cyyRewardPerDay: rewardPerDay,
                    ...
                    roiPerMonth,
                    roiPerYear,
                    rewardPerThousand: 1 * roiPerDay * (1000 / cyyPrice),
