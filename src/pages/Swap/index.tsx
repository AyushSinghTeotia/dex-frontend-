...
import { ChainId, CurrencyAmount, JSBI, Token, Trade } from 'quest-cyswap-sdk'
...
export default function Swap() {
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Swap`)} | Cyswap</title>
                <meta
                    name="description"
            ...
            <div className="swap-outer-box bg-dark-900 w-full max-w-2xl rounded sc-box-shadow">
                ...
                <Wrapper id="swap-page">
                    ...
                    {/*                        {i18n._(t`Check out cycoin on Polygon (Matic)`)}*/}
                    {/*                    </div>*/}
                    ...
                    {/* <a
                        href={
                            'https://app.cyswap.com/swap?inputCurrency=0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48&outputCurrency=0xe9f84de264e91529af07fa2c746e934397810334'
                        }
                        ...
                        <div className="justify-between flex pl-5 pr-8 items-center gap-6">
                            ...
                            >
                                ...
                                <div className="text-xs">
                                    <Trans>Swap for SAK3 token on CYY now. Click here to swap.</Trans>
                                </div>
                            </div>
                        </div>
                        <div className="justify-between flex pl-5 pr-8 items-center gap-6">
