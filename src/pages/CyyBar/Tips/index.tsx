...
const tips: readonly Tip[] = [
    {
        ...
        image: BentoSquare,
        description:
            'Deposit your xCYY into BentoBox to passively earn yield through an xCYY investment strategy, or use as collateral within Kashi and future Bento dapps.',
        href: '#'
    },
    {
        ...
        image: Vote,
        description:
            'As an xCYY holder, your share of the staking pool correlates to the weight of your vote when participating in on-chain governance.',
        href: '#'
    },
    {
        ...
        image: AaveSquare,
        description:
            'Deposit your xCYY into Aave to receive aXCYY to earn collateral interest and borrowing power.',
        href: '#'
    },
    {
        ...
        description: (
            <>
                ...
                by depositing xCYY or by staking your CYY LP tokens from the{' '}
                <Link to="#" className="underline">
                    CYY/xCYY
                </Link>{' '}
                and/or{' '}
...
export default function CyyBarTips() {
    ...
    return (
        <>
            ...
            <div className="w-full max-w-2xl mb-4">
                ...
                <div className="text-high-emphesis text-h4">Make the most of your xCYY.</div>
                <div className="text-gray-500 py-3">
                    You can leave the bar and exchange your xCYY for CYY (as well as collect any earned interest) at
                    any time. However, there are more ways to use xCYY to maximize your yield potential!
                </div>
