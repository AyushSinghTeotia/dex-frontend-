...
import { Currency, ETHER, TokenAmount, WETH, currencyEquals } from 'quest-cyswap-sdk'
...
export default function AddLiquidity({
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Add Liquidity`)} | CYY</title>
            </Helmet>
            ...
            <div className="bg-dark-900 w-full max-w-2xl rounded z-10 shadow-liquidity-purple-glow sc-box-shadow">
