...
import { ChainId, Currency, ETHER, Percent, WETH, currencyEquals } from 'quest-cyswap-sdk'
...
export default function RemoveLiquidity({
            ...
            <>
                <RowBetween>
                    <Text color={theme.text2} fontWeight={500} fontSize={16}>
                        {i18n._(t`CYY ${currencyA?.getSymbol(chainId)}/${currencyB?.getSymbol(chainId)} Burned`)}
                    </Text>
                    <RowFixed>
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Remove Liquidity`)} | Cyswap</title>
            </Helmet>
            ...
            <div className="bg-dark-900 w-full max-w-2xl rounded  shadow-liquidity-purple-glow sc-box-shadow">
